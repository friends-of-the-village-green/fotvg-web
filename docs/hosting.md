...
| Sanity Studio | (same Sanity project) | — | John; Betsy and Kathleen being added as Editors | Deployed 9 Aug 2026 to **https://fotvg.sanity.studio**, app ID `llg85ofl96ybrc4e2d0yr0lj`. Hosted by Sanity, not Netlify, so it costs no build credits. **Does not update itself when the schema changes** — see `docs/runbook.md`. |
