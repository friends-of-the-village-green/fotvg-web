...
| Service | Account owner (email) | Plan | Who has access | Notes |
|---|---|---|---|---|
...
| GitHub org | | Free | | |
| Netlify (prototype) | john.thegardener.bullivant@gmail.com (personal) | Free | John | Site `fotvg-webtest.netlify.app`, connected to the `fotvg-web` repo. **Temporary.** Build credits come out of John's personal allowance. Open-source/public-good application: not yet filed as of 9 Aug 2026. |
...
| Greenworks mission/vision | [Google Doc](https://docs.google.com/document/d/14YYrAZ_LMMm02FCMTJr0UQ6DmdZgGgEVSREJHGNaafQ/edit) | John, **editor** | Shared by Kathleen Bullivant, 9 August 2026. Content transcribed into `docs/organization.md`. |
...
the connector is authorized against
**`johnbullivant@northwestperennialalliance.org`**, not John's personal Gmail.
...
FotVG items were shared to **`john.thegardener.bullivant@gmail.com`** (the shared drive
by Catherine on 28 July, the Greenworks doc by Kathleen on 9 August), and both are
invisible to the connector. In the browser, signed in as John personally, the FotVG
shared drive appears normally.
